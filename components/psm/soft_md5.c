 ...
 * MD5 process buffer
 */
int32_t utils_md5_update(utils_md5_context_t *ctx,const unsigned char *input,uint32_t ilen)
{
    int32_t ret;
    uint32_t fill;
    uint32_t left;
 ...
 * MD5 final digest
 */
int32_t utils_md5_finish(utils_md5_context_t *ctx, unsigned char output[16])
{
    int32_t ret;
    uint32_t used;
    uint32_t high, low;
