...
#define json_e(...)	 log_e("json", ##__VA_ARGS__)
#define json_w(...)	log_w("json", ##__VA_ARGS__)

#ifdef CONFIG_JSON_DEBUG
	#define json_d(...)	log("json", ##__VA_ARGS__)
#else
	#define json_d(...)
