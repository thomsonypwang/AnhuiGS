...
aiot_sysdep_portfile_t * aiot_sysdep_get_portfile(void)
{
    if (g_sysdep_portfile == NULL ||
        ...
        g_sysdep_portfile->core_sysdep_sem_deinit == NULL ||
        g_sysdep_portfile->core_sysdep_sem_init == NULL ||
        g_sysdep_portfile->core_sysdep_sem_release == NULL ||
        g_sysdep_portfile->core_sysdep_sem_take == NULL ||
        g_sysdep_portfile->core_sysdep_thread_create == NULL ||
        g_sysdep_portfile->core_sysdep_thread_destroy == NULL) {
        return NULL;
    }
